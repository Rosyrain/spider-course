...
本文当中的代码可能会有残缺，各位如果直接复制可能无法运行，可以去我的 GitHub 主页：[Rosyrain (github.com)](https://github.com/Rosyrain)  `https://github.com/rosyrain`，

下一篇文章会讲解其他的解析html的语言：`beautifulsoup`  也叫的bs4。
